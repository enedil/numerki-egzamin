...
gdzie: $$c_{k} = f_{0,1,2,\ldots,k}$$ oraz $$f_{i,i+1, \ldots, k+i} \stackrel{def}{=} \frac{f_{i+1,...,k} + f_{i,...(i+k-1)}}{x_{i+k}-x_{i}}$$
...
$$|E(f)| = \left| \sum_{k=1}^{N}\frac{H^3f''(\xi_k)}{12} \right| \leq \frac{H^2(b-a)}{12}\underset{\xi \in [a,b]}{\sup}|f\prime \prime (\xi)|$$
